...
const dummyVariants: ProductVariantOption[] = [
  {
    id: 1,
    name: "Grande",
    product: {
      name: "Galletas de Zanahoria",
    },
  },
  {
    id: 2,
...
const NewProcessPage = () => {
  ...
  const [variants] = useState<ProductVariantOption[]>(dummyVariants);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setModal({
      ...
      message: "Dummy process created locally. No backend request was sent.",
      error: false,
    });
  };
  ...
  return (
    <div className={`page ${styles.pageWrapper}`}>
      ...
      <div className={styles.headerContainer}>
        ...
        <p>
          Define la información base, materias primas y pasos para el nuevo
          flujo de producción.
        </p>
      </div>
              ...
              <div key={index} className={styles.materialRow}>
                ...
                <div className={styles.quantityGroup}>
                  ...
                  <select
                    value={material.unit}
                    onChange={(e) =>
                      updateRawMaterial(index, "unit", e.target.value)
                    }
                  ...
                  <div className={styles.checkboxGroup}>
                    <label className={styles.checkboxLabel}>
                      <input
                        ...
                        onChange={(e) =>
                          updateStep(step.id, "hasInput", e.target.checked)
                        }
                      />
